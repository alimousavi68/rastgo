    ...
    while ($category_posts->have_posts()) {
        ...
        <div class="<?php echo $col; ?> px-1">
            <div class="post-flip-box-container" class="image_frame">
                <?php echo i8_the_thumbnail('8-500-280', 'post-flip-box-image object-fit-cover' . $thumb_radius, array("width" => 500, "height" => 'auto')); ?>
                ...
                <div class="post-flip-box-overlay d-flex align-items-end">
                    <h2 class="post-flip-box-title0">
                        <a class="f31 post-flip-box-link l1 fw-7 fd-7  text-white i8-blink"
                            href="<?php echo get_the_permalink(); ?>"><?php i8_limit_text(get_the_title(), 72, '...'); ?></a>
                    </h2>
                </div>
            </div>
        </div>
...
if ($category_posts2->have_posts()) {
    ...
    while ($category_posts2->have_posts()) {
        ...
        <div class="col-24 col-lg-12 col-md-12 col-sm-24 col-xl-12 px-1">
            <div class="post-flip-box-container" class="image_frame">
                <?php echo i8_the_thumbnail('i8-290-222', 'post-flip-box-image object-fit-cover' . $thumb_radius, array("width" => 290, "height" => '195')); ?>
                ...
                <div class="post-flip-box-overlay d-flex align-items-end">
                    <h2 class="post-flip-box-title0">
                        <a class="<?php echo $title_font_size; ?> post-flip-box-link l1  i8-blink fw-3 fd-7 text-white"
                            href="<?php echo get_the_permalink(); ?>"><?php i8_limit_text(get_the_title(), 72, '...'); ?></a>
                    </h2>
                </div>
            </div>
