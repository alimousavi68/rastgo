                        ...
                        <form action="<?php echo esc_url(home_url('/')); ?>" method="get" class="search-form">
                            ...
                            <div class="overflow-hidden js-select2-box">
                                ...
                                <select class="form-select cs-select-inp" name="review_result" aria-label="">
                                    ...
                                    <option value="false" <?php if (isset($_GET['review_result'])) {
                                                                selected($review_result, 'false');
                                                            } ?>>نادرست</option>
                                    <option value="halftrue" <?php if (isset($_GET['review_result'])) {
                                                                    selected($review_result, 'halftrue');
                                                                } ?>>نیمه درست</option>
                                </select>
                            </div>
